...
def create_pointset(data, xn, yn):
    ...
    for algo, algo_name, dataset_name, xv, yv in data:
        ...
        if comparator(xv, last_x):
            ...
            ys.append(yv)
            ls.append(algo_name)
    return xs, ys, ls, axs, ays, als, datasets
...
def compute_metrics(true_nn_distances, res, metric_1, metric_2, recompute=False):
    ...
    for i, (properties, run) in enumerate(res):
        ...
        all_results.setdefault(algo, []).append((algo, algo_name, dataset_name, metric_1_value, metric_2_value))
